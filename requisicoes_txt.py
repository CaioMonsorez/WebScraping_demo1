...
#Status code: 200 --- status da requisicao de acesso HTTP (existem outros 404, 300... depende da familia)
...
#o comando acima imprime o conteudo inteiro em forma de codigo fonte do site